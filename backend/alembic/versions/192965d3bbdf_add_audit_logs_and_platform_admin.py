"""Add audit logs and platform admin

Revision ID: 192965d3bbdf
Revises: b2c2dfe236a2
Create Date: 2026-05-12 08:22:56.106621
...
revision: str = '192965d3bbdf'
down_revision: Union[str, Sequence[str], None] = 'b2c2dfe236a2'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_audit_logs_ngo_id'), 'audit_logs', ['ngo_id'], unique=False)
    op.create_index(op.f('ix_audit_logs_target_user_id'), 'audit_logs', ['target_user_id'], unique=False)

    # Adding column with server_default to handle existing rows
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_audit_logs_ngo_id'), table_name='audit_logs')
